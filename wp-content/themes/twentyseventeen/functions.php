...
//{
    ...
    //$char_list = '&@'; /** If you want count certain symbols as 'words' **/
	 ...
	 //echo $enddata=strip_tags($post->post_content);echo"----";$enddata;
	 //echo $udata=preg_replace('/ +/', ' ', preg_replace('/[^A-Za-z0-9 ]/', ' ', urldecode(html_entity_decode(strip_tags($post->post_content)))));
	 //echo "-------"; $udata; 
	 //echo str_word_count(preg_replace('/[^A-Za-z0-9 !@#$%^&*().]/u','', strip_tags($post->post_content)));
	//echo  str_word_count(preg_replace('/ +/', ' ', preg_replace('/[^A-Za-z0-9 ]/', ' ', urldecode(html_entity_decode(strip_tags($post->post_content))))));
//}
function word_count() {
