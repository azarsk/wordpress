 ...
 * copy this file to "wp-config.php" and fill in the values.azar masyrtr
 *
 * This file contains the following configurations:config changes azar master new branchs
 * 
 * * MySQL settings
 * * Secret keys
